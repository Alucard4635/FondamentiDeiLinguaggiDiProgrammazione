...
public class AssemblerGrammarParser extends Parser {
	...
	public final GlobalsContext globals() throws RecognitionException {
		...
		try {
			...
			setState(50); ((GlobalsContext)_localctx).INT = match(INT);
	...
	public final FunctionDeclarationContext functionDeclaration() throws RecognitionException {
		...
		try {
			...
			setState(55); ((FunctionDeclarationContext)_localctx).name = match(ID);
			setState(56); match(T__3);
			setState(57); match(T__4);
			setState(58); match(T__0);
			setState(59); ((FunctionDeclarationContext)_localctx).a = match(INT);
			setState(60); match(T__2);
			setState(61); match(T__1);
			setState(62); match(T__0);
			setState(63); ((FunctionDeclarationContext)_localctx).n = match(INT);
	...
	public final LabelAddressContext labelAddress() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(66); ((LabelAddressContext)_localctx).ID = match(ID);
	...
	public final InstrContext instr() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(70); ((InstrContext)_localctx).ID = match(ID);
				setState(71); ((InstrContext)_localctx).operand = operand();
			...
			case 2:
				...
				{
				setState(74); ((InstrContext)_localctx).ID = match(ID);
	...
	public static final String _serializedATN =
		...
		"\2\2\60\61\3\2\2\2\61\63\3\2\2\2\62\60\3\2\2\2\63\64\7\4\2\2\64\65\7\f"+
		"\2\2\65\66\7\20\2\2\66\67\b\3\1\2\67\5\3\2\2\289\7\3\2\29:\7\n\2\2:;\7"+
		"\6\2\2;<\7\5\2\2<=\7\t\2\2=>\7\f\2\2>?\7\7\2\2?@\7\b\2\2@A\7\t\2\2AB\7"+
		"\f\2\2BC\b\4\1\2C\7\3\2\2\2DE\7\n\2\2EF\7\6\2\2FG\b\5\1\2G\t\3\2\2\2H"+
