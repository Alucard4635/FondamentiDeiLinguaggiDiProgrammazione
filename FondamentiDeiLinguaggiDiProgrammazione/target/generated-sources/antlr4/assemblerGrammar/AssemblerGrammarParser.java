...
public class AssemblerGrammarParser extends Parser {
	...
	public final GlobalsContext globals() throws RecognitionException {
		...
		try {
			...
			setState(51); ((GlobalsContext)_localctx).INT = match(INT);
	...
	public final FunctionDeclarationContext functionDeclaration() throws RecognitionException {
		...
		try {
			...
			setState(56); ((FunctionDeclarationContext)_localctx).name = match(ID);
			setState(57); match(T__3);
			setState(58); match(T__4);
			setState(59); match(T__0);
			setState(60); ((FunctionDeclarationContext)_localctx).a = match(INT);
			setState(61); match(T__2);
			setState(62); match(T__1);
			setState(63); match(T__0);
			setState(64); ((FunctionDeclarationContext)_localctx).n = match(INT);
	...
	public final InstrContext instr() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(67); ((InstrContext)_localctx).ID = match(ID);
				setState(68); ((InstrContext)_localctx).operand = operand();
			...
			case 2:
				...
				{
				setState(71); ((InstrContext)_localctx).ID = match(ID);
	...
	public final LabelAddressContext labelAddress() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(77); ((LabelAddressContext)_localctx).ID = match(ID);
	...
	public static final String _serializedATN =
		...
		"\7\4\2\2\65\66\7\f\2\2\66\67\7\20\2\2\678\b\3\1\28\5\3\2\2\29:\7\3\2\2"+
		":;\7\n\2\2;<\7\6\2\2<=\7\5\2\2=>\7\t\2\2>?\7\f\2\2?@\7\7\2\2@A\7\b\2\2"+
		"AB\7\t\2\2BC\7\f\2\2CD\b\4\1\2D\7\3\2\2\2EF\7\n\2\2FG\5\n\6\2GH\b\5\1"+
		"\2HL\3\2\2\2IJ\7\n\2\2JL\b\5\1\2KE\3\2\2\2KI\3\2\2\2L\t\3\2\2\2MN\t\2"+
		"\2\2N\13\3\2\2\2OP\7\n\2\2PQ\7\6\2\2QR\b\7\1\2R\r\3\2\2\2\n\17\24\31\37"+
		"#)\61K";
