...
public class AssemblerParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'.def'", "'.globals'", "'args'", "'f'", "'i'", "':'", "','", 
		"'locals'", "'='", "ARITHMETIC", "COMPARISON", "INTEGER_UNARY_OPERATION", 
		"'g'", "MEMORY_OPERATION", "'br'", "UNCONDITIONAL", "CALL", "'ret'", "'print'", 
		"'halt'", "REG", "ID", "FUNC", "INT", "CHAR", "STRING", "FLOAT", "WS", 
		"NEWLINE"
	};
	public static final int
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__8) | (1L << T__5) | (1L << T__4) | (1L << INTEGER_UNARY_OPERATION) | (1L << GLOBAL) | (1L << MEMORY_OPERATION) | (1L << CONDITIONAL) | (1L << UNCONDITIONAL) | (1L << CALL) | (1L << RETURN) | (1L << STREAM) | (1L << EXIT) | (1L << ID) | (1L << NEWLINE))) != 0) );
			}
		}
	...
	public final InstructionContext instruction() throws RecognitionException {
		...
		try {
			...
			case T__4:
				{
				setState(70); stackBynaryOperator();
				}
				break;
			case INTEGER_UNARY_OPERATION:
				{
				setState(71); stackUnary();
				}
				break;
			case GLOBAL:
			case MEMORY_OPERATION:
				{
				setState(72); memoryStackOperation();
				}
				break;
			case CONDITIONAL:
			case UNCONDITIONAL:
			...
			case RETURN:
				{
				setState(74); funcionOperation();
				}
				break;
			case STREAM:
			case EXIT:
				{
				setState(75); systemCall();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final StackBynaryOperatorContext stackBynaryOperator() throws RecognitionException {
		...
		try {
			...
			case T__4:
				{
				setState(80); integerBynaryOperation();
				}
				break;
			case T__5:
				{
				setState(81); floatBynaryOperation();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final StackUnaryContext stackUnary() throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(90); match(INTEGER_UNARY_OPERATION);
			}
			}
		}
		catch (RecognitionException re) {
	...
	public final MemoryStackOperationContext memoryStackOperation() throws RecognitionException {
		...
		try {
			...
			if (_la==GLOBAL) {
				{
				setState(92); match(GLOBAL);
				}
			}

			setState(95); match(MEMORY_OPERATION);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static final String _serializedATN =
		...
		"-\3\2\2\2+)\3\2\2\2+,\3\2\2\2,.\3\2\2\2-+\3\2\2\2./\7\4\2\2/\60\7\32\2"+
		"\2\60\61\7\37\2\2\61\5\3\2\2\2\62\63\7\3\2\2\63\64\7\36\2\2\64\65\7\30"+
		"\2\2\65\66\7\36\2\2\66\67\7\b\2\2\678\7\36\2\289\7\5\2\29:\7\36\2\2:;"+
		"\7\13\2\2;<\7\36\2\2<=\7\32\2\2=>\7\36\2\2>?\7\t\2\2?@\7\36\2\2@A\7\n"+
		"\2\2AB\7\36\2\2BC\7\13\2\2CD\7\36\2\2DE\7\32\2\2EF\7\36\2\2FG\7\37\2\2"+
		"G\7\3\2\2\2HO\5\n\6\2IO\5\20\t\2JO\5\22\n\2KO\5\24\13\2LO\5\26\f\2MO\5"+
		"\30\r\2NH\3\2\2\2NI\3\2\2\2NJ\3\2\2\2NK\3\2\2\2NL\3\2\2\2NM\3\2\2\2OP"+
		"\3\2\2\2PQ\7\37\2\2Q\t\3\2\2\2RU\5\f\7\2SU\5\16\b\2TR\3\2\2\2TS\3\2\2"+
		"\2U\13\3\2\2\2VW\7\7\2\2WX\t\2\2\2X\r\3\2\2\2YZ\7\6\2\2Z[\t\2\2\2[\17"+
		"\3\2\2\2\\]\7\16\2\2]\21\3\2\2\2^`\7\17\2\2_^\3\2\2\2_`\3\2\2\2`a\3\2"+
		"\2\2ab\7\20\2\2b\23\3\2\2\2cd\t\3\2\2de\7\36\2\2ef\7\30\2\2f\25\3\2\2"+
		"\2gh\t\4\2\2h\27\3\2\2\2ij\t\5\2\2j\31\3\2\2\2kl\7\30\2\2lm\7\b\2\2m\33"+
		"\3\2\2\2\t\35$&+NT_";
