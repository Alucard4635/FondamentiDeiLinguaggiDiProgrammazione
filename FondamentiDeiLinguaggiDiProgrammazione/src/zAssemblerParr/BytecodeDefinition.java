...
public class BytecodeDefinition {
    public static final int REG =0; // AssemblerParser.REG;
    public static final int FUNC =0 ;//AssemblerParser.FUNC;
    public static final int INT = 0;//AssemblerParser.INT;
