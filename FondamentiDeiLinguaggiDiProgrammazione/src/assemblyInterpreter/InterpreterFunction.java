...
public class InterpreterFunction {
	...
	public InterpreterFunction(String id,int nArg,int nLocals, int address){
		name = id;
		argumentNumber = nArg;
	...
	public boolean equals(Object obj) {
		if (obj instanceof InterpreterFunction){
			InterpreterFunction f=(InterpreterFunction) obj;
